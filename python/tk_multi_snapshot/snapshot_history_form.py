...
class SnapshotHistoryForm(QtGui.QWidget):
    ...
    restore = QtCore.Signal(QtGui.QWidget, six.string_types, six.string_types)
    ...
    def refresh(self):
        ...
        try:
            ...
            # throws an exception!
            msg = (
                "Failed to find the current work file path:\n\n"
                "%s\n\n"
        ...
        # load file list:
        self._ui.snapshot_list.load({"handler": self._handler, "file_path": self._path})
