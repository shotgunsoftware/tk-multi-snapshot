...
class SnapshotForm(QtGui.QWidget):
    ...
    def __init__(self, file_path, thumbnail, setup_cb, parent=None):
        ...
        self._ui.comment_edit.keyPressEvent = lambda e, df=self._ui.comment_edit.keyPressEvent: self._on_comment_edit_key_pressed(
            df, e
        )
