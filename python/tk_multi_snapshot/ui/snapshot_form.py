...
"}")
        ...
        self.save_as_btn = QtGui.QPushButton(self.snapshot_page)
        self.save_as_btn.setMinimumSize(QtCore.QSize(145, 0))
...
"scene that you can easily go back to later.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.save_as_btn.setText(QtGui.QApplication.translate("SnapshotForm", "Save As Instead...", None, QtGui.QApplication.UnicodeUTF8))
